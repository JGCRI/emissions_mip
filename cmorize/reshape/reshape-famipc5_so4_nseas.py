"""
Convert CESM FAMIPC5_SO4_NSEAS time-slice output to time-series output via PyReshape
...
class dirs:
    ...
    INPUT  = 'model-output/pnnl-cesm/FAMIPC5_SO4_NSEAS/run'
    OUTPUT = 'model-output/pnnl-cesm/FAMIPC5_SO4_NSEAS/timeseries'

print('Hello from reshape-FAMIPC5_SO4_NSEAS.py!')
...
# input_fnames = ['FAMIPC5_SO4_NSEAS.cam.h0.2010-09.nc', 'FAMIPC5_SO4_NSEAS.cam.h0.2010-10.nc']
input_fnames = conversion_utils.fetch_fnames(dirs.INPUT, 'FAMIPC5_SO4_NSEAS', 'cam')
