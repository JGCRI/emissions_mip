"""
Convert CESM FAMIPC5_MERRA2 time-slice output to time-series output via PyReshape
...
class dirs:
    ...
    INPUT  = 'model-output/pnnl-cesm/FAMIPC5_MERRA2/run'
    OUTPUT = 'model-output/pnnl-cesm/FAMIPC5_MERRA2/timeseries'
    
print('Hello from reshape-FAMIPC5_MERRA2.py!')
...
# input_fnames = ['FAMIPC5_MERRA2.cam.h0.2010-09.nc', 'FAMIPC5_MERRA2.cam.h0.2010-10.nc']
input_fnames = conversion_utils.fetch_fnames(dirs.INPUT, 'FAMIPC5_MERRA2', 'cam')
