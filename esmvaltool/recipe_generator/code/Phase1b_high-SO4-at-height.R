...
for (region in region_list) {
  ...
  part4 <- as.yaml(list(diagnostics = list(Emissions_MIP_analysis = list(description = 'Model variable outputs',
                                                                         ...
                                                                         variables = list(mmrso4 = list(preprocessor = 'preproc_sfc',
                                                                                                        ...
                                                                                                        additional_datasets = list('{dataset: E3SM-1-0, project: CMIP6, activity: CMIP, institute: E3SM-Project, exp: nudge-ref, ensemble: r1i1p1f1, grid: gr}',
                                                                                                                                   '{dataset: E3SM-1-0, project: CMIP6, activity: CMIP, institute: E3SM-Project, exp: nudge-high-so4-at-height, ensemble: r1i1p1f1, grid: gr}')),
  ...
  # Write out yaml file
  write(c(part1, part2, part3, part4), paste0("Phase1bv1.1/", region, "/", region, "_", diff_type, "_high-SO4-at-height.yml"))
}
