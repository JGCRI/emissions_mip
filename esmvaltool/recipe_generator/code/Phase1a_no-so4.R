...
for (region in region_list) {
  ...
  datasets <- list(datasets = list('{dataset: E3SM-1-0, project: CMIP6, activity: CMIP, institute: E3SM-Project, exp: nudge-ref, ensemble: r1i1p1f1, grid: gr}',
                                   '{dataset: E3SM-1-0, project: CMIP6, activity: CMIP, institute: E3SM-Project, exp: nudge-no-SO4, ensemble: r1i1p1f1, grid: gr}',
                                   '{dataset: GISS-nudge, project: CMIP6, activity: AerChemMIP, institute: NASA-GISS, exp: reference, ensemble: r1i1p5f1, grid: gn}',
                                   '{dataset: GISS-nudge, project: CMIP6, activity: AerChemMIP, institute: NASA-GISS, exp: no-SO4, ensemble: r1i1p5f1, grid: gn}',
                                   '{dataset: MIROC-SPRINTARS, project: MIROC, activity: EmiMIP, institute: RIAM, exp: BASE, ensemble: r1i1p1f1, grid: gr}',
                                   '{dataset: MIROC-SPRINTARS, project: MIROC, activity: EmiMIP, institute: RIAM, exp: SO4N, ensemble: r1i1p1f1, grid: gr}',
                                   '{dataset: GFDL, project: GFDL, activity: EmiMIP, institute: E3SM-Project, exp: base, ensemble: r1i1p1f1, grid: gr}',
                                   '{dataset: GFDL, project: GFDL, activity: EmiMIP, institute: E3SM-Project, exp: no-so4, ensemble: r1i1p1f1, grid: gr}',
                                   '{dataset: CESM2-WACCM, project: CMIP6, activity: CMIP, institute: NCAR, exp: nudge-ref, ensemble: r1i1p1f1, grid: gr}',
                                   '{dataset: CESM2-WACCM, project: CMIP6, activity: CMIP, institute: NCAR, exp: nudge-no-SO4, ensemble: r1i1p1f1, grid: gr}',
                                   '{dataset: GEOS, project: GEOS, activity: EmiMIP, institute: E3SM-Project, exp: base, ensemble: r1i1p1f1, grid: gr}',
                                   '{dataset: GEOS, project: GEOS, activity: EmiMIP, institute: E3SM-Project, exp: no-so4, ensemble: r1i1p1f1, grid: gr}',
                                   '{dataset: UKESM, project: UKESM, activity: EmiMIP, institute: E3SM-Project, exp: base, ensemble: r1i1p1f1, grid: gr}',
                                   '{dataset: UKESM, project: UKESM, activity: EmiMIP, institute: E3SM-Project, exp: no_so4, ensemble: r1i1p1f1, grid: gr}'))
  ...
  part4 <- as.yaml(list(diagnostics = list(Emissions_MIP_analysis = list(description = 'Model variable outputs',
                                                                        ...
                                                                        variables = list(mmrso4 = list(preprocessor = 'preproc_sfc',
                                                                                                       ...
                                                                                                       additional_datasets = list('{dataset: CESM-1-0, project: CMIP6, activity: CMIP, institute: PNNL-WACCEM, exp: nudge-ref, ensemble: r1i1p1f1, grid: gr}',
                                                                                                                                  '{dataset: CESM-1-0, project: CMIP6, activity: CMIP, institute: PNNL-WACCEM, exp: nudge-no-SO4, ensemble: r1i1p1f1, grid: gr}',
                                                                                                                                  '{dataset: NorESM2, project: NorESM2, activity: EmiMIP, institute: E3SM-Project, exp: base, ensemble: r1i1p1f1, grid: gr}',
                                                                                                                                  '{dataset: NorESM2, project: NorESM2, activity: EmiMIP, institute: E3SM-Project, exp: no-so4, ensemble: r1i1p1f1, grid: gr}',
                                                                                                                                  '{dataset: OsloCTM3, project: OsloCTM3, activity: EmiMIP, institute: E3SM-Project, exp: base, ensemble: r1i1p1f1, grid: gr}',
                                                                                                                                  '{dataset: OsloCTM3, project: OsloCTM3, activity: EmiMIP, institute: E3SM-Project, exp: no-so4, ensemble: r1i1p1f1, grid: gr}')),
  ...
  # Write out yaml file
  write(c(part1, part2, part3, part4), paste0("Phase1a/", region, "/", region, "_", diff_type, "_no-so4.yml"))
}
