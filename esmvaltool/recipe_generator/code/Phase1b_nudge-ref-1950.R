...
for (region in region_list) {
  ...
  part4 <- as.yaml(list(diagnostics = list(Emissions_MIP_analysis = list(description = 'Model variable outputs',
                                                                         ...
                                                                         variables = list(mmrso4 = list(preprocessor = 'preproc_sfc',
                                                                                                        ...
                                                                                                        additional_datasets = list('{dataset: E3SM-1-0, project: CMIP6, activity: CMIP, institute: E3SM-Project, exp: nudge-ref-1950, ensemble: r1i1p1f1, grid: gr, start_year: 2000, end_year: 2009}',
                                                                                                                                   '{dataset: CESM-1-0, project: CMIP6, activity: CMIP, institute: PNNL-WACCEM, exp: nudge-ref-1950, ensemble: r1i1p1f1, grid: gr, start_year: 2000, end_year: 2009}')),
  ...
  write(c(part1, part2, part3, part4), paste0("Phase1bv1.1/", region, "/", region, "_nudge-ref-1950.yml"))
}
