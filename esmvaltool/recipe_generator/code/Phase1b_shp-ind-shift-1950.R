# ------------------------------------------------------------------------------
# Program Name: Phase1b_shp-ind-shift-1950.R
# Authors: Hamza Ahsan
...
for (region in region_list) {
  ...
  datasets <- list(datasets = list('{dataset: GISS-E2-1-G, project: CMIP6, activity: AerChemMIP, institute: NASA-GISS, exp: BW1950, ensemble: r1i1p5f1, grid: gn, start_year: 2000, end_year: 2009}', 
                                   '{dataset: GISS-E2-1-G, project: CMIP6, activity: AerChemMIP, institute: NASA-GISS, exp: IOSHFT1950, ensemble: r1i1p5f1, grid: gn, start_year: 2000, end_year: 2009}'))
  ...
  part4 <- as.yaml(list(diagnostics = list(Emissions_MIP_analysis = list(description = 'Model variable outputs',
                                                                        ...
                                                                        variables = list(mmrso4 = list(preprocessor = 'preproc_sfc',
                                                                                                       ...
                                                                                                       additional_datasets = list('{dataset: CESM-1-0, project: CMIP6, activity: CMIP, institute: PNNL-WACCEM, exp: nudge-ref-1950, ensemble: r1i1p1f1, grid: gr, start_year: 2000, end_year: 2009}',
                                                                                                                                  '{dataset: CESM-1-0, project: CMIP6, activity: CMIP, institute: PNNL-WACCEM, exp: nudge-shp-ind-shift-1950, ensemble: r1i1p1f1, grid: gr, start_year: 2000, end_year: 2009}',
                                                                                                                                  ...
                                                                                                                                  '{dataset: E3SM-1-0, project: CMIP6, activity: CMIP, institute: E3SM-Project, exp: nudge-shp-ind-shift-1950, ensemble: r1i1p1f1, grid: gr, start_year: 2000, end_year: 2009}')),
  ...
  # Write out yaml file
  write(c(part1, part2, part3, part4), paste0("Phase1bv1.1/", region, "/", region, "_", diff_type, "_shp-ind-shift-1950.yml"))
}
