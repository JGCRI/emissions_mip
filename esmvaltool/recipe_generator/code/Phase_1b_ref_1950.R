...
for (region in region_list) {
  ...
  datasets <- list(datasets = list('{dataset: GISS-nudge, project: CMIP6, activity: AerChemMIP, institute: NASA-GISS, exp: BW1950, ensemble: r1i1p5f1, grid: gn}'))
  ...
  write(c(part1, part2, part3, part4), paste0("Phase1bv1.1/", region, "/", region, "_reference-1950.yml"))
}
