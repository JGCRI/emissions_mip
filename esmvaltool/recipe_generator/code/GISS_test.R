# ------------------------------------------------------------------------------
# Program Name: Phase1b_shp-30p-red-1950.R
# Authors: Hamza Ahsan
...
for (region in region_list) {
  ...
  datasets <- list(datasets = list('{dataset: GISS-nudge, project: CMIP6, activity: AerChemMIP, institute: NASA-GISS, exp: reference, ensemble: r1i1p5f1, grid: gn}', 
                                   '{dataset: GISS-nudge, project: CMIP6, activity: AerChemMIP, institute: NASA-GISS, exp: 2000SHPdot7SO2, ensemble: r1i1p5f1, grid: gn}'))
  ...
  part4 <- as.yaml(list(diagnostics = list(Emissions_MIP_analysis = list(description = 'Model variable outputs',
                                                                        themes = list('phys'),
                                                                        realms = list('atmos'),
                                                                        variables = list(dms = list(preprocessor = 'preproc_sfc',
                                                                                                    mip = 'AERmon',
                                                                                         ...
                                                                                         cl = list(preprocessor = 'preproc_sfc',
                                                                                                   ...
                                                                                                   start_year = as.integer(2000),
                                                                                                   end_year = as.integer(2004),
                                                                                                   additional_datasets = list('{dataset: E3SM-1-0, project: CMIP6, activity: CMIP, institute: E3SM-Project, exp: nudge-ref, ensemble: r1i1p1f1, grid: gr}',
                                                                                                                              '{dataset: E3SM-1-0, project: CMIP6, activity: CMIP, institute: E3SM-Project, exp: nudge-shp-30p-red, ensemble: r1i1p1f1, grid: gr}')),
                                                                                         clivi = list(preprocessor = 'preproc_nolev',
                                                                                                      ...
                                                                                                      additional_datasets = list('{dataset: CESM-1-0, project: CMIP6, activity: CMIP, institute: PNNL-WACCEM, exp: nudge-ref, ensemble: r1i1p1f1, grid: gr}',
                                                                                                                                 '{dataset: CESM-1-0, project: CMIP6, activity: CMIP, institute: PNNL-WACCEM, exp: nudge-shp-30p-red, ensemble: r1i1p1f1, grid: gr}',
  ...
  # Write out yaml file
  write(c(part1, part2, part3, part4), paste0("Phase1bv1.1/", region, "/", region, "_", diff_type, "_shp-30p-red_GISS_test.yml"))
}
